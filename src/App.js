...
import { MoisturProduct } from './pages/MoisturProduct';
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/body' element={<CartProvider><Body></Body></CartProvider>}></Route>
        ...
        <Route path="/products/:id" element={<MoisturProduct />}></Route>
        ...
        <Route path="/track" element={<TrackShipment></TrackShipment>}></Route>
